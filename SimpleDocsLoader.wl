...
If[Temp`PackageScope`SimpleDocsLoading`Private`$DependencyLoad,
  Unprotect["`SimpleDocs`PackageScope`Private`$TopLevelLoad"];
  Evaluate[Symbol["`SimpleDocs`PackageScope`Private`$TopLevelLoad"]]=False,
  Unprotect["SimpleDocs`PackageScope`Private`$TopLevelLoad"];
  Evaluate[Symbol["SimpleDocs`PackageScope`SimpleDocsLoading`$TopLevelLoad"]]=
